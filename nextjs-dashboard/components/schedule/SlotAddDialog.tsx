...
export function SlotAddDialog({ open, onOpenChange, tutorId, tutorName, onAdd }: SlotAddDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl text-blue-700">Add New Time Slot</DialogTitle>
        ...
        <div className="space-y-4">
          {/* Day Selection */}
          <div>
            <Label htmlFor="day">Day of Week <span className="text-red-500">*</span></Label>
            <select
              id="day"
              value={dayOfWeek}
